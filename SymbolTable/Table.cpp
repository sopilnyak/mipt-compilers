...
const MethodInfo* Table::GetMethod(const std::string& name, const Position& position) const
{
    ...
    throw DeclarationException("Method " + name + " is not declared in this scope", position);
}
...
const VariableInfo* Table::GetVariable(const std::string& name, const Position& position) const
{
    ...
    throw DeclarationException("Variable " + name + " is not declared in this scope", position);
}

bool Table::HasTypeSuper(const ClassInfo* classInfo, const StringSymbol *super, const Position position) const
{
...
const ClassInfo* Table::GetClass(const std::string& name, const Position& position) const
{
    ...
    throw DeclarationException("Type " + name + " is not declared in this scope", position);
}
