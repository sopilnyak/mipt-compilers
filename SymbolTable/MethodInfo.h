...
namespace SymbolTable {
    ...
    public:
        MethodInfo(const std::string& _name, const std::string& className, Position _position, TypeInfo _returnType,
        ...
        const std::vector<const VariableInfo*>& GetVarsNames() const;
